    ...
    <body>
        ...
        <div class="full-background col-xs-12">
            <a class="view2 col-xs-12">
                <img src="/images/Pano/Uinta-Trees.jpg" class="img-responsive" alt="Uinta Mountains, Pine Trees, Mountain Photography, Utah Landscape Photography"><br>
            </a>       
            <div class="content">
                <h1>
                    Trees on the Mountain                 
                </h1>
                <h2>This was another one from our hike up Kletting peak and I just loved all the trees we were walking through
